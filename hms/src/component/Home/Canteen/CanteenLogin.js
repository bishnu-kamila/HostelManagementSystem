...
function CanteenLogin() {
  const [canteenregdId, setCanteenregdId] = useState("");
      ...
      <form className="sign-in-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            value={canteenregdId}
            onChange={(e) => setCanteenregdId(e.target.value)}
          />
        ...
        <Link to="/canteenHome"><button type="submit" className="btn">Login</button></Link>
